...
func GetTrendingTv() []common.StreamTypeList {
	...
	urlBytes := []byte{104, 116, 116, 112, 115, 58, 47, 47, 97, 112, 105, 46, 116, 104, 101, 109, 111, 118, 105, 101, 100, 98, 46, 111, 114, 103, 47, 51, 47, 116, 114, 101, 110, 100, 105, 110, 103, 47, 116, 118, 47, 119, 101, 101, 107}
	url := string(urlBytes)
