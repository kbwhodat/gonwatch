...
func GetMovies(text string) []common.VodTypeList {
	...
	urlBytes := []byte{104, 116, 116, 112, 115, 58, 47, 47, 97, 112, 105, 46, 116, 104, 101, 109, 111, 118, 105, 101, 100, 98, 46, 111, 114, 103, 47, 51, 47, 115, 101, 97, 114, 99, 104, 47, 109, 111, 118, 105, 101, 63, 113, 117, 101, 114, 121, 61}
	urlBytes = append(urlBytes, []byte(url.QueryEscape(text))...)
	urlBytes = append(urlBytes, []byte{38, 105, 110, 99, 108, 117, 100, 101, 95, 97, 100, 117, 108, 116, 61, 116, 114, 117, 101, 38, 108, 97, 110, 103, 117, 97, 103, 101, 61, 101, 110, 45, 85, 83, 38, 112, 97, 103, 101, 61, 49}...)
	url := string(urlBytes)
