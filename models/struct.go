...
func (i BubbleTeaSeasonList) Description() string {
	return strconv.Itoa(int(i.EpisodeCount)) + " episodes"
}
...
func (i BubbleTeaEpisodeList) Title() string {
	return i.EpisodeTitle + " (s" + strconv.Itoa(int(i.SeasonNumber)) + "e" + strconv.Itoa(int(i.EpisodeId)) + ")"
}
func (i BubbleTeaEpisodeList) Description() string { return i.EpisodePlot }
func (i BubbleTeaEpisodeList) FilterValue() string {
	return i.EpisodeTitle + " (s" + strconv.Itoa(int(i.SeasonNumber)) + "e" + strconv.Itoa(int(i.EpisodeId)) + ")" + " " + i.Country
}
...
func (i BubbleTeaAnimeSeasonList) Title() string {
	return i.SeasonTitle + " ⭐ " + strconv.FormatFloat(i.SeasonRating, 'f', -1, 64)
}
...
type BubbleTeaRecentlyWatchedList struct {
	ItemType   string
	ItemTmdbID int64
	SeasonNum  int
	SeasonID   string
...
func (e BubbleTeaRecentlyWatchedList) Type() string {
	return "recently_watched_" + e.ItemType
}
func (e BubbleTeaRecentlyWatchedList) ID() int64 {
	return e.EpisodeNum
}
func (e BubbleTeaRecentlyWatchedList) SznNumber() int {
	return e.SeasonNum
}
func (e BubbleTeaRecentlyWatchedList) SznID() int {
	return 0
}
func (e BubbleTeaRecentlyWatchedList) TmdbID() int64 {
	return e.ItemTmdbID
}
func (e BubbleTeaRecentlyWatchedList) EpList() []string {
	return []string{}
}
func (e BubbleTeaRecentlyWatchedList) EpString() string {
	return strconv.FormatInt(e.EpisodeNum, 10)
}
func (e BubbleTeaRecentlyWatchedList) SportId() string {
	return ""
}
func (e BubbleTeaRecentlyWatchedList) SportName() string {
	return ""
}
func (e BubbleTeaRecentlyWatchedList) OriginCountry() string {
	return ""
}
func (e BubbleTeaRecentlyWatchedList) GetSeasonID() string {
	return e.SeasonID
}
func (e BubbleTeaRecentlyWatchedList) GetItemType() string {
	return e.ItemType
}

func (i BubbleTeaRecentlyWatchedList) Title() string {
	if i.ItemType == "anime_episode" {
		parts := strings.Split(i.ItemTitle, "|")
		if len(parts) > 1 {
			return parts[1] + " (E" + strconv.FormatInt(i.EpisodeNum, 10) + ")"
		}
	}
	return i.ItemTitle
}
func (i BubbleTeaRecentlyWatchedList) Description() string {
	return "Watched " + i.WatchedAt
}
func (i BubbleTeaRecentlyWatchedList) FilterValue() string {
	return i.ItemTitle
}
